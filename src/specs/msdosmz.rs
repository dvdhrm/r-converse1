...
mod tests {
    ...
    fn verify_headerext() {
        ...
        assert_eq!(int::ForeignEndian::to_native(e.lfanew), 0x0080);
    ...
    fn verify_relocation() {
        ...
        assert_eq!(int::ForeignEndian::to_native(r.offset), 0x0010);
        assert_eq!(int::ForeignEndian::to_native(r.segment), 0x0020);
    ...
    fn verify_stub_x86() {
        ...
        assert_eq!(h.magic, MAGIC);
        assert_eq!(int::ForeignEndian::to_native(h.cblp), 128);
        assert_eq!(int::ForeignEndian::to_native(h.cp), 1);
        assert_eq!(int::ForeignEndian::to_native(h.crlc), 0);
        assert_eq!(int::ForeignEndian::to_native(h.cparhdr), 4);
        assert_eq!(int::ForeignEndian::to_native(h.minalloc), 0x0000);
        assert_eq!(int::ForeignEndian::to_native(h.maxalloc), 0xffff);
        assert_eq!(int::ForeignEndian::to_native(h.ss), 0x00);
        assert_eq!(int::ForeignEndian::to_native(h.sp), 0x80);
        assert_eq!(int::ForeignEndian::to_native(h.csum), 0xa768);
        assert_eq!(int::ForeignEndian::to_native(h.ip), 0);
        assert_eq!(int::ForeignEndian::to_native(h.cs), 0);
        assert_eq!(int::ForeignEndian::to_native(h.lfarlc), 0x40);
        assert_eq!(int::ForeignEndian::to_native(h.ovno), 0x00);

        // Verify expected extended header.
        assert_eq!(e.res, [0; 8]);
        assert_eq!(int::ForeignEndian::to_native(e.oemid), 0x00);
        assert_eq!(int::ForeignEndian::to_native(e.oeminfo), 0x00);
