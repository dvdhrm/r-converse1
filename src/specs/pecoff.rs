...
#[repr(C)]
pub struct Header {
    pub machine: int::u16le,
    pub number_of_sections: int::u16le,
    pub time_date_stamp: int::u32le,
    pub pointer_to_symbol_table: int::u32le,
    pub number_of_symbols: int::u32le,
    pub size_of_optional_header: int::u16le,
    pub characteristics: int::u16le,
}

#[repr(C)]
pub struct OptionalHeader<FORMAT: format::Type = format::Pe> {
    pub magic: int::u16le,
    pub major_linker_version: int::u8le,
    pub minor_linker_version: int::u8le,
    pub size_of_code: int::u32le,
    pub size_of_initialized_data: int::u32le,
    pub size_of_uninitialized_data: int::u32le,
    pub address_of_entry_point: int::u32le,
    pub base_of_code: int::u32le,
...
pub struct OptionalHeaderExt<FORMAT: format::Type = format::Pe> {
    ...
    pub section_alignment: int::u32le,
    pub file_alignment: int::u32le,
    pub major_operating_system_version: int::u16le,
    pub minor_operating_system_version: int::u16le,
    pub major_image_version: int::u16le,
    pub minor_image_version: int::u16le,
    pub major_subsystem_version: int::u16le,
    pub minor_subsystem_version: int::u16le,
    pub win32_version_value: int::u32le,
    pub size_of_image: int::u32le,
    pub size_of_headers: int::u32le,
    pub check_sum: int::u32le,
    pub subsystem: int::u16le,
    pub dll_characteristics: int::u16le,
    ...
    pub loader_flags: int::u32le,
    pub number_of_rva_and_sizes: int::u32le,
}
...
pub struct SectionHeader {
    pub name: [u8; 8],
    pub virtual_size: int::u32le,
    pub virtual_address: int::u32le,
    pub size_of_raw_data: int::u32le,
    pub pointer_to_raw_data: int::u32le,
    pub pointer_to_relocations: int::u32le,
    pub pointer_to_linenumbers: int::u32le,
    pub number_of_relocations: int::u16le,
    pub number_of_linenumbers: int::u16le,
    pub characteristics: int::u32le,
}
...
pub mod format {
    ...
    impl Type for Pe {
        type AddressSpace = super::int::u32le;
        type BaseOfData = super::int::u32le;
    }

    pub struct Pe32P {}

    impl Type for Pe32P {
        type AddressSpace = super::int::u64le;
        type BaseOfData = ();
    }
}
